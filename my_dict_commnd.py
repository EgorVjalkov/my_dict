command_dict_git = [
    ['git diff', 'no input', 'выводит изменения текущей версии MODIFIED файлов'],
    ['git diff --staged', 'no input', 'выводит изменения текущей версии STAGED файлов'],
    ['git log', 'no input' 'выводит список коммитов'],
    ['git log -p', 'no input', 'выводит изменения для каждого коммита'], 
    ['git log --online', 'no input', 'выводит сокращенный список коммитов (hash, massage)'],
    ['git log --graph', 'no input', 'выводит сокращенный список коммитов (hash, massage) со связями'],
    ['git show <hash>','принимает хэш коммита', 'выводит все изменения в рамках этого коммита'],
    ['git blame <path>', 'принимает путь до файла', 'выводит хэш, автора и дату коммита каждой строки этого файла'],
